...
```
curl -Ls https://raw.githubusercontent.com/l-g-t/tuic-hy2-node.js-python/main/hy2.sh | sed 's/\r$//' | bash
```
...
```
curl -Ls https://raw.githubusercontent.com/l-g-t/tuic-hy2-node.js-python/main/tuic.sh | sed 's/\r$//' | bash
```
